// Tipos para integracao com UAZAPI
...
// Interface para status completo extraido da UAZAPI
export interface InstanciaStatusCompleto {
  connected: boolean
  loggedIn: boolean
  phoneNumber: string | null      // Extraido do JID (ex: 5511999999999)
  phoneFormatted: string | null   // Formatado (ex: +55 11 99999-9999)
  profileName: string | null      // Nome de exibicao do WhatsApp
  profilePicUrl: string | null    // URL da foto do perfil
  isBusiness: boolean             // Se eh WhatsApp Business
  platform: string | null         // android/ios/web
  lastDisconnect: string | null   // Timestamp do ultimo disconnect
...
// Tipo para instancia com estado de conexao
export interface InstanciaComConexao extends InstanciaWhatsApp {
  connected: boolean
  loggedIn: boolean
}

// Mapeamento de status UAZAPI para portugues
...
// Tipos para configuracao de Webhook
...
// Tipos para webhooks de conexao recebidos do N8N
...
// Response type for connect endpoint
