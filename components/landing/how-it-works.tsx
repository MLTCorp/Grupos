...
const steps = [
  {
    ...
    description:
      "Escaneie o QR Code e conecte sua instancia WhatsApp em segundos. Sem necessidade de root ou modificacoes.",
  },
  {
    number: "02",
    icon: Settings,
    ...
    description:
      "Importe seus grupos, defina categorias, configure comandos e personalize as automacoes.",
  },
  {
    number: "03",
    icon: Rocket,
    ...
    description:
      "Deixe a plataforma trabalhar por voce. Envie mensagens, execute comandos e monitore tudo em tempo real.",
  },
]
