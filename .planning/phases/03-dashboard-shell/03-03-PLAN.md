...
must_haves:
  ...
  key_links:
    ...
    - from: "components/onboarding/tour-provider.tsx"
      ...
      via: "imports driver.js CSS"
      pattern: "driver.js/dist/driver.css"
---
...
IMPORTANT: Import Supabase client using the established pattern:
```typescript
...
- Client component
- IMPORTANT: Import driver.js AND its CSS:
```typescript
...
- `grep "createClient" components/onboarding/use-onboarding.ts` (confirms Supabase import)
- `grep "driver.js/dist/driver.css" components/onboarding/tour-provider.tsx` (confirms CSS import)
  </verify>
  <done>
driver.js installed.
useOnboarding hook checks instances count using createClient from @/lib/supabase/client.
TourProvider imports driver.js and its CSS, configures and runs tour with Portuguese text.
  </done>
</task>
